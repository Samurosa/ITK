...
const (
	ChatAPI_Create_FullMethodName = "/proto.ChatAPI/Create"
	ChatAPI_Delete_FullMethodName = "/proto.ChatAPI/Delete"
	ChatAPI_Send_FullMethodName   = "/proto.ChatAPI/Send"
)
...
func (c *chatAPIClient) Send(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*SendMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendMessageResponse)
	err := c.cc.Invoke(ctx, ChatAPI_Send_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChatAPIServer) Send(context.Context, *SendMessageRequest) (*SendMessageResponse, error) {
...
func _ChatAPI_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatAPIServer).Send(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatAPI_Send_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatAPIServer).Send(ctx, req.(*SendMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Send",
			Handler:    _ChatAPI_Send_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "ChatApi/proto/api.proto",
}
